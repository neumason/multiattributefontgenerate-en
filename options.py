...
def get_parser():
    ...
    parser.add_argument("--multi_gpu", type=bool, default=False, help="whether or not multi gpus")
    # Data
    ...
    parser.add_argument("--style_out_channel", type=int, default=166, help="number of style embedding channel")
    ...
    # Lambdas
    parser.add_argument("--lambda_l1", type=float, default=5.0, help='pixel l1 loss lambda')
    parser.add_argument("--lambda_char", type=float, default=50.0, help='char class loss lambda')
